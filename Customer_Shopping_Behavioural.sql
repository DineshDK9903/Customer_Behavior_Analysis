...
--Q2. which customer's used a discount but still spent more than the average purchase amount ?
...
-- Q7. Segemnt customers into new, Returning, and Loyal based on their total number of 
-- previous purchases, and show the Loyal based on their total.
